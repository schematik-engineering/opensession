...
| Voice                     | `OPENSESSION_TRANSCRIPTION_PROVIDER`, `GEMINI_API_KEY`, `OPENAI_API_KEY`, `GROQ_API_KEY`, `WHISPER_CLI`, `WHISPER_MODEL`                                               | [integrations-misc.md](integrations-misc.md#voice--transcription)                      |
...
| AWS-hosted MCP            | EC2 instance role + AWS CLI v2 (system-scope Linux)                                                                                                                    | [integrations-misc.md](integrations-misc.md#aws-hosted-mcp-with-iam)                   |
